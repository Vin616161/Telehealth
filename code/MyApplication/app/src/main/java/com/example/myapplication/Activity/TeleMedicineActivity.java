...
public class TeleMedicineActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Call<ResponseBody> call= netRequestService.getDisease(LoginActivity.sp.getString("token",""));
        call.enqueue(new Callback<ResponseBody>() {
            ...
            public void onFailure(Call<ResponseBody> call, Throwable t) {
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(TeleMedicineActivity.this, "Error!", Toast.LENGTH_SHORT).show();
                    }
                });
